...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Administrador',
            fields=[
                ('nombre_usuario', models.CharField(primary_key=True, serialize=False, default='-', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_usuario', models.CharField(primary_key=True, serialize=False, default='-', max_length=18)),
                ('contrasena', models.CharField(max_length=15, default='-')),
